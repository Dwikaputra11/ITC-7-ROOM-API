...
public class DetailActivity extends Fragment {
    ...
    private ArrayList<DetailLiga> list = new ArrayList<>();
    ...
    public static DetailActivity newInstance(String param1) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView tvJuaraLiga = view.findViewById(R.id.tv_juaraLiga);


        tvJuaraLiga.setText("Juara Liga : " + mParam1);
